...
--
-- Host: localhost    Database: suitevideojuegos
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'dba79052-54e1-11f1-9fca-04bf1b20d87f:1-489';
...
CREATE TABLE `movimientos` (
  ...
  `NumeroTurno` int DEFAULT NULL,
  `FechaMovimiento` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`IdMovimiento`),
  KEY `IdPartida` (`IdPartida`),
  CONSTRAINT `movimientos_ibfk_1` FOREIGN KEY (`IdPartida`) REFERENCES `partidas` (`IdPartida`)
...
-- Dump completed on 2026-06-04 20:50:07
